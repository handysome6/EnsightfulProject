...
'video/x-raw(memory:NVMM), format=NV12, width=4056, height=3040, framerate=(fraction)10/1' ! \
tee name=t ! \
queue ! nvv4l2h264enc insert-sps-pps=true idrinterval=15 ! h264parse !  rtph264pay ! \
